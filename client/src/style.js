const styles = {
    ...
    container: "flex w-full max-w-[64rem] flex-col items-start justify-start bg-transparent pt-[1rem] laptop:pt-[2rem] laptop:px-[1rem] desktop:px-0 mt-[5.5rem] tablet:mt-[6.75rem] pb-[3rem]",
