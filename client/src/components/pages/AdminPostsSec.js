...
import TablePostsSec from '../organisms/tables/TablePostsSec.js'
import { Link } from 'react-router-dom'

export default function AdminPostsSec() {
  return (
            ...
            <div className='w-full flex flex-1 flex-col'>
                ...
                <div className='bg-bgColor h-full p-[1rem]'>
                    <div className='flex flex-row justify-start gap-3 items-center mb-[1.5rem]'>
                        ...
                        <Link to='/approvedposts'><button className='p-2 rounded-xl  border-2 bg-[#84cc16] text-white border-transparent'>Approved Posts</button></Link>
