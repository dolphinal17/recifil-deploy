        ...
        <div className='h-screen w-full bg-primary p-[1rem] tablet:p-[2rem] desktop:p-[3rem]'>
            <div className='max-w-[82rem] w-full mx-auto'>
                ...
                <p className='text-mainBlack text-base tablet:text-lg font-light tablet:font-normal text-justify'>
                    ...
                    <span className='text-mainBlack text-base tablet:text-lg font-normal tablet:font-medium'>Definitions</span><br/>
                    ...
                    Country refers to: Philippines<br/><br/>
    
                    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ReciFil.<br/><br/>
                    ...
                    Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the TermsFeed Terms and Conditions Generator.<br/><br/>
                    ...
                    Website refers to ReciFil, accessible from https://dolphinal17.github.io/recifil-deploy/<br/><br/>
                    ...
                    By visiting this page on our website: https://dolphinal17.github.io/recifil-deploy/
