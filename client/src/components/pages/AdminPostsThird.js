...
import TablePostsThird from '../organisms/tables/TablePostsThird.js'


export default function AdminPostsThird() {
    return (
                ...
                <div className='w-full flex flex-1 flex-col'>
                    ...
                    <div className='bg-bgColor h-full p-[1rem]'>
                        <div className='flex flex-row justify-start gap-3 items-center mb-[1.5rem]'>
                            ...
                            <Link to='/pendingposts'><button className='p-2 rounded-xl border-black text-black border-2 hover:bg-[#84cc16] hover:text-white hover:border-transparent'>Pending Posts</button></Link>
                            ...
                            <Link to='/archivedposts'><button className='p-2 rounded-xl border-2 bg-[#84cc16] text-white border-transparent'>Archived Posts</button></Link>
