...
function CardSuggRecipeBasket() {
  return (
    <div className='col-span-1 max-w-[450px] min-h-[100px] tablet:w-[450px] flex flex-col tablet:flex-row rounded-md shadow-md'>
        <img src="http://images.summitmedia-digital.com/yummyph/images/2019/08/30/spicybeefbulalorecipe.jpg" alt="" className='w-full object-cover rounded-t-md tablet:w-[150px] tablet:h-[100px] tablet:rounded-l-md tablet:rounded-r-none'/>
