    ...
    useEffect(() => {
        async function fetchRecipe() {
            ...
            if (docSnap.exists()) {
                ...
                setTempIng(docSnap.data().ingredients)
                setTempSteps(docSnap.data().steps)
            }
        }
        fetchRecipe();
    }, [id]);
        ...
        <div className='w-full'>
            <form onSubmit={handleSubmit} className='w-full max-w-[30rem] border border-zinc-400 mx-auto p-[2rem]'>
                ...
                <div className={`w-[4rem] h-[4rem] border border-dashed border-zinc-400 flex flex-none justify-center items-center`}>
                            <img src={tempImg || formData.image} className='w-[4rem] h-[4rem] object-cover' />
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        setFormData((prevFormData) => ({
                            ...
                            image: tempImg ? tempImg : prevFormData.image  // Update the formData with the new image URL
                        }));
