...
const LandingNavbar = () => {
  return (
    <nav className='w-full z-10 tablet:absolute top-0'>
        <div className='max-w-[82rem] px-4 tablet:px-8 flex justify-between m-auto items-center py-5 z-10'>
            <div className='flex items-center gap-[0.5rem] tablet:gap-[1rem]'>
                <img src="https://firebasestorage.googleapis.com/v0/b/recifil.appspot.com/o/webimages%2FLogoMainG.png?alt=media&token=c25b6fd5-4217-4b56-af19-4aa6208abcc8" alt='recifillogo' className='w-[1.5rem] laptop:w-[3rem]'/>

                <h1 className='text-xl tablet:text-3xl text-textMainBlack font-bold'>ReciFil</h1>
            </div>
