...
export default function NavbarAdmin() {
  return (
    <nav className='flex items-center w-full h-[4rem] px-[1rem] tablet:px-[1.5rem] bg-gray-700'>
        <div className='flex w-full justify-end'>
            ...
            <div className='flex gap-[0.5rem] tablet:gap-[1rem] items-center'>
                <div className='flex gap-[0.125rem] tablet:gap-[0.25rem] items-center'>
                    ...
                    <span className='text-sm font-light tablet:font-normal text-white'>Admin</span>
                </div>

                <FontAwesomeIcon icon={faGear} className='text-sm text-white'/>
            </div>
        </div>
    </nav>
  )
