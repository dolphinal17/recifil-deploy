...
export default function ModalDeleteArchive({onOpen, onClose, handleDeleteClick}) {
      ...
      <div className='bg-textFadeBlack fixed inset-0 z-50'>
            <div className='flex h-screen justify-center items-center'>
                <div className='p-[2rem] flex flex-col gap-[1rem] tablet:gap-[2rem] bg-primary rounded-lg'>
                    ...
                    <span className='text-base tablet:text-xl font-light tablet:font-normal text-mainBlack'>Are you sure, you want to permanently delete this post?</span>
