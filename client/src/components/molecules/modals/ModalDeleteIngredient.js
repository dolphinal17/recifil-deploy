...
export default function ModalDeleteIngredient({onOpen, onClose, onClick}) {
      ...
      <div className='bg-textFadeBlack fixed inset-0 z-50'>
            <div className='flex h-screen justify-center items-center'>
                <div className='p-[2rem] flex flex-col gap-[1rem] tablet:gap-[2rem] bg-primary rounded-lg'>
                    ...
                    <span className='text-base tablet:text-xl font-light tablet:font-normal text-mainBlack'>Are you sure, you want to delete this ingredient?</span>
